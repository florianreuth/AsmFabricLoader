...
package de.florianreuth.asmfabricloader.transformer;
...
public class MixinInfoTransformer {
    ...
    static {
        try {
            ...
            final Class<?> mixinTransformerBootstrapClass = Class.forName("de.florianreuth.asmfabricloader.loader.feature.classtransform.MixinTransformerBootstrap", true, targetLoader);
